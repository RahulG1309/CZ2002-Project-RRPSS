...
/**
 * 
 * @author A This entire class helps to faciliate printing neat and tidy tables
 *         for our contents
 */
public class TableGenerator {
	...
	/**
	 * String TABLE_H_SPLIT_SYMBOL prints the symbol splitting the rows between the
	 * header and the data
	 */
	 ...
	 * @param overRiddenHeaderHeight - overriding the HeaderHeight to not exceed
	 *                               more than 1 line
	 ...
	 * @param length        - gets the length of the padding between the Strings of
	 *                      the data
	 */
	...
	public static void printtable(ArrayList<MenuItems> m, int a) {
		...
		/*
		 * for(int i=0;i<2;i++) { row.add("string"); row.add("test"); rowsList.add(row);
		 * }
		 */
	...
	/**
	 * This method deals with the printing of individual MenuItems of package
	 * contents
	 * 
	 * @param m    - gets the ArrayList of MenuItems
	 ...
	 * 
	 * @param m     - gets the ArrayList of MenuItems
	 * @param price - gets the corresponding price of the said items (total price of
	 *              the items)
	 */
